...
import com.synopsys.integration.blackduck.artifactory.modules.inspection.notifications.service.content.detail.NotificationContentDetail;
    ...
    private Optional<CompositeComponentModel> generateCompositeComponentModel(final NotificationContentDetail notificationContentDetail) {
        ...
        try {
            ...
            if (optionalComponentVersionUriResponse.isPresent() && optionalVersionBomComponentViewUriSingleResponse.isPresent()) {
                ...
                throw new IntegrationException("ProjectVersion data was missing from service");
            }
        } catch (final IntegrationException e) {
            intLogger.error(String.format("Could not parse service to get all component details: %s", e.getMessage()), e);
        }
