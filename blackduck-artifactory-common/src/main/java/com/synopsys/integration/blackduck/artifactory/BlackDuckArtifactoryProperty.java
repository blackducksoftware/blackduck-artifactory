...
public enum BlackDuckArtifactoryProperty {
    ...
    HIGH_VULNERABILITIES2("highVulnerabilities2"),
    MEDIUM_VULNERABILITIES2("mediumVulnerabilities2"),
    LOW_VULNERABILITIES2("lowVulnerabilities2"),
    POLICY_STATUS("policyStatus"),
    COMPONENT_VERSION_URL("componentVersionUrl"),
    COMPONENT_VERSION_URL2("componentVersionUrl2"),
